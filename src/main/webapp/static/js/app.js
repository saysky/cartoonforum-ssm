...
function showSuccessMsg(text) {
    showMsg(text, "success", 1000);
}

function showErrorMsg(text) {
    showMsg(text, "error", 1000);
}
...
function showSuccessMsgAndReload(text) {
    showMsgAndReload(text, "success", 1000);
}

function showErrorMsgAndReload(text) {
    showMsgAndReload(text, "error", 1000);
}
...
function showSuccessMsgAndRedirect(text, redirectUrl) {
    showMsgAndRedirect(text, "success", 1000, redirectUrl);
}

function showErrorMsgAndRedirect(text, redirectUrl) {
    showMsgAndRedirect(text, "error", 1000, redirectUrl);
}
